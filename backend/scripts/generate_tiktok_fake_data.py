...
CAMPAIGNS = [
    {"campaign_id": "1789000000010001", "campaign_name": "TikTok | Spark Ads Marca",              "account_id": ACCOUNTS[0], "impr_range": (150000, 420000), "ctr_range": (0.6, 1.6), "cpm_range": (8, 20),  "cvr_range": (0.4, 1.2), "aov_range": (28, 65)},
    {"campaign_id": "1789000000010002", "campaign_name": "TikTok | In-Feed Remarketing",           "account_id": ACCOUNTS[0], "impr_range": (30000, 90000),   "ctr_range": (1.8, 3.6), "cpm_range": (6, 16),  "cvr_range": (2.5, 6.0), "aov_range": (35, 80)},
    {"campaign_id": "1789000000010003", "campaign_name": "TikTok | Lanzamiento Categoria Hogar",   "account_id": ACCOUNTS[0], "impr_range": (60000, 160000),  "ctr_range": (1.0, 2.2), "cpm_range": (7, 18),  "cvr_range": (1.2, 3.0), "aov_range": (32, 70)},
    {"campaign_id": "1789000000010004", "campaign_name": "TikTok | TopView Promo Fin de Semana",   "account_id": ACCOUNTS[1], "impr_range": (90000, 250000),  "ctr_range": (1.3, 2.8), "cpm_range": (10, 24), "cvr_range": (1.8, 4.2), "aov_range": (25, 55)},
    {"campaign_id": "1789000000010005", "campaign_name": "TikTok | Video Shopping Ecommerce",      "account_id": ACCOUNTS[1], "impr_range": (100000, 280000), "ctr_range": (1.5, 3.0), "cpm_range": (9, 22),  "cvr_range": (2.0, 5.0), "aov_range": (30, 68)},
]
