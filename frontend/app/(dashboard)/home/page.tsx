...
const modules = [
  ...
  },
  {
    ...
    features: [
      { icon: FilePresentation, label: "Carga Excel" },
      { icon: FilePresentation, label: "Plantilla PPTX" },
      { icon: FilePresentation, label: "Descarga automática" },
      { icon: FilePresentation, label: "3 cenefas por slide" },
    ],
    tag: "PPTX",
