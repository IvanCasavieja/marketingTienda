...
function CanvasPlaceholder() {
  return (
    <div className="flex-1 flex items-center justify-center bg-slate-200 dark:bg-slate-950 rounded-lg">
    ...
    <div className="flex flex-col h-[calc(100vh-2rem)] -m-8 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-card bg-white dark:bg-slate-900">
      ...
      <div className="flex flex-1 min-h-0">
        ...
        {showImport && !templateId ? (
          <main className="flex-1 flex items-center justify-center bg-slate-100 dark:bg-slate-950 p-8">
            <ImportPanel onDismiss={() => setShowImport(false)} />
          </main>
        ) : (
          <main className="relative flex-1 overflow-auto bg-slate-100 dark:bg-slate-950 flex flex-col items-center p-6 gap-4">
