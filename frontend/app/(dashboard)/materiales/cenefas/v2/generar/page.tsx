...
const VARIABLES_REFERENCE = [
  ...
  // Decimales
  { name: "decimalRegular",    desc: "Decimal del precio regular" },
  ...
  { name: "mecanica",          desc: "Mecánica o tipo de oferta" },
  { name: "aclaracion1",       desc: "Primera aclaración / aviso legal" },
  { name: "aclaracion2",       desc: "Segunda aclaración" },
  { name: "aclaracion3",       desc: "Tercera aclaración" },
