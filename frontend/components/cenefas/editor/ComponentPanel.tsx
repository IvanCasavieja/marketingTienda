...
const CATALOG: { category: string; items: ComponentBlueprint[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Aclaración 1",
        type: "text", variable: "aclaracionUno", transform: "none",
        icon: <Type size={14} />, color: "text-slate-400 dark:text-slate-500",
      ...
      {
        label: "Legales",
        type: "text", variable: "legales", transform: "none",
        icon: <Type size={14} />, color: "text-slate-400 dark:text-slate-500",
        defaults: { style: { font_size: 9 },
  ...
  },
  {
    ...
    items: [
      {
        label: "Día",
        type: "text", variable: "dia", transform: "none",
        icon: <Type size={14} />, color: "text-slate-500 dark:text-slate-400",
