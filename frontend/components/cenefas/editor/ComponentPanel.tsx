...
const CATALOG: { category: string; items: ComponentBlueprint[] }[] = [
    ...
    items: [
      {
        ...
        type: "text", variable: "precio", transform: "price_full",
      ...
      {
        label: "Precio — entero",
        type: "text", variable: "precio", transform: "price_integer",
        icon: <Type size={14} />, color: "text-blue-600",
      ...
      },
      {
        ...
        type: "text", variable: "precio", transform: "price_decimal",
  ...
  },
  {
    ...
    items: [
      {
        label: "Tipo (P1)",
        type: "text", variable: "tipo_promocion", transform: "uppercase",
    ...
    items: [
      {
        ...
        type: "text", variable: "code", transform: "none",
        icon: <Type size={14} />, color: "text-slate-400",
        defaults: { style: { font_size: 10 },
