...
const CATALOG: { category: string; items: ComponentBlueprint[] }[] = [
  {
    ...
    items: [
      ...
      {
        label: "Precio principal — decimal aparte",
        type: "text", variable: "decimalPrecioP", transform: "price_full",
      ...
      {
        label: "Precio oferta — decimal aparte",
        type: "text", variable: "decimalPrecioOferta", transform: "price_full",
        icon: <Type size={14} />, color: "text-blue-300",
        defaults: { style: { font_size: 16, color: "#1E3A5F" },
                    base_bounds: { x: 9, y: 12, width: 2, height: 1.2 } },
      },
      {
        label: "Oferta 1 / 2 / 3",
        type: "text", variable: "oferta1", transform: "price_full",
