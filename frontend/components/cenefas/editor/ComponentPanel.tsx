...
const CATALOG: { category: string; items: ComponentBlueprint[] }[] = [
  {
    ...
    items: [
      {
        label: "Precio regular completo",
        type: "text", variable: "precioRegular", transform: "price_full",
      ...
      {
        label: "Precio regular — entero",
        type: "text", variable: "precioRegular", transform: "price_integer",
        icon: <Type size={14} />, color: "text-blue-600",
        defaults: { style: { font_size: 96, font_bold: true, color: "#E31E24", align: "center" },
                    base_bounds: { x: 1.5, y: 8, width: 7, height: 4 } },
      },
      {
        label: "Precio regular — decimal",
        type: "text", variable: "decimalRegular", transform: "none",
      ...
      {
        label: "Precio oferta",
        type: "text", variable: "precioOferta", transform: "price_full",
        icon: <Type size={14} />, color: "text-emerald-500",
        defaults: { style: { font_size: 48, font_bold: true, color: "#10B981" },
                    base_bounds: { x: 1, y: 6, width: 8, height: 2.5 } },
      },
      {
